...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scoreViewModel.score.observe(this, Observer { score ->
            ...
            if(score > 100){
                textToDisplay += "\nYou are doing great!\uD83D\uDD25. Maintain your score. Don't get distract by social media.\nYou have \uD83C\uDF1F \uD83C\uDF1F \uD83C\uDF1F\uD83C\uDF1F stars"
            }else if(score > 0){
                textToDisplay += "\nYou can increase your score\uD83D\uDE4C. Stay focus!. Don' get distract by social media.\nYou have \uD83C\uDF1F stars"
            }else if(score > -100){
                textToDisplay += "\nYou have entered danger zone\uD83D\uDE31. You can still be better. Don't use social media.\nYou have \uD83D\uDEA9\uD83D\uDEA9\uD83D\uDEA9 flags"
            }else{
                textToDisplay += "You are in danger zone⛔⛔. You need to stop using social media. Please don't use social media.\nYou have \uD83D\uDEA9\uD83D\uDEA9\uD83D\uDEA9\uD83D\uDEA9\uD83D\uDEA9 flags"
            }
